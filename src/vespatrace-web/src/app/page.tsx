        ...
        <div className="relative max-w-7xl mx-auto text-center">
          <div className="mb-8">
            <div className="inline-flex items-center space-x-2 bg-orange-500/10 text-orange-400 px-4 py-2 rounded-full border border-orange-500/20 mb-6">
              ...
              <span className="text-sm font-medium">Powered by .NET 9 & AI Detection</span>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            {[
              { icon: Activity, label: 'Active Monitors', value: '1,247', color: 'text-blue-400' },
              { icon: AlertTriangle, label: 'Alerts Today', value: '23', color: 'text-yellow-400' },
              { icon: CheckCircle, label: 'Verified Sightings', value: '89', color: 'text-green-400' },
              { icon: Shield, label: 'Protected Areas', value: '156', color: 'text-purple-400' },
            ].map((stat, index) => (
